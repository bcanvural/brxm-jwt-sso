        ...
        'chosen', '$timeout', '$parse', function (config, $timeout, $parse) {
            ...
            return {
                ...
                link: function (scope, element, attr, ctrls) {
                    var $render, chosen, directiveOptions, disableIfEmpty, empty, initIfNotInitialized, match, ngModel,
                        ngSelect, options, startLoading, stopLoading, timer, trackBy, valuesExpr, viewWatch;
